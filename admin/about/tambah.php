          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama_About_post" class="form-control" placeholder="Masukan Nama About" required>
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label>Isi About</label>
                <textarea name="isi_About_post" class="form-control" rows="3" placeholder="Masukan isi About" required></textarea>
              </div>
            </div>
        </div>
