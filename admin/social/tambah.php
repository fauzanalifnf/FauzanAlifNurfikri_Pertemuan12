          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="nama_Social_post" class="form-control" placeholder="Masukan Nama Social" required>
              </div>
              <div class="form-group">
                <label>Link</label>
                <input type="text" name="nama_Link_post" class="form-control" placeholder="Masukan Link" required>
              </div>
              <div class="input-group mb-3">
                <label>Pilih Icon</label>
              </div>
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="icon_post">
