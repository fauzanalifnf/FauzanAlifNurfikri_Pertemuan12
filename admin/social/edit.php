...
$nama_sosmed_post = $data['nama_sosmed'];
$link_post = $data['link'];
$icon_post = $data['icon'];
//
?>
          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_Social_post" class="form-control" placeholder="Masukan Nama Sosmed" value="<?= $nama_sosmed_post ?>" required>
              </div>
              <div class="form-group">
                <label>Link Sosmed</label>
                <input type="text" name="nama_Link_post" class="form-control" placeholder="Masukan Link Sosmed" value="<?= $link_post ?>" required>
              </div>
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="icon_post" value="<?= $icon_post ?>">
